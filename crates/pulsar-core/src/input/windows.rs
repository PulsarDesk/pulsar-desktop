...
fn evdev_to_vk(code: u32) -> Option<u16> {
	Some(match code {
		...
		28 => 0x0D,                         // Enter
		29 => 0xA2,                         // Left Ctrl
		30 => 0x41, 31 => 0x53, 32 => 0x44, 33 => 0x46, 34 => 0x47, 35 => 0x48, // A S D F G H
		36 => 0x4A, 37 => 0x4B, 38 => 0x4C, // J K L
		39 => 0xBA,                         // ;  (VK_OEM_1)
		40 => 0xDE,                         // '  (VK_OEM_7)
		41 => 0xC0,                         // `  (VK_OEM_3)
		42 => 0xA0,                         // Left Shift
		43 => 0xDC,                         // \  (VK_OEM_5)
		44 => 0x5A, 45 => 0x58, 46 => 0x43, 47 => 0x56, 48 => 0x42, 49 => 0x4E, 50 => 0x4D, // Z X C V B N M
		...
		69 => 0x90,                         // Num Lock
		70 => 0x91,                         // Scroll Lock
		71 => 0x67, 72 => 0x68, 73 => 0x69, // Numpad 7 8 9
		74 => 0x6D,                         // Numpad -  (VK_SUBTRACT)
		75 => 0x64, 76 => 0x65, 77 => 0x66, // Numpad 4 5 6
		78 => 0x6B,                         // Numpad +  (VK_ADD)
		79 => 0x61, 80 => 0x62, 81 => 0x63, // Numpad 1 2 3
		82 => 0x60,                         // Numpad 0
