...
use windows::Win32::Media::MediaFoundation::{
    ...
    MFTEnumEx, MFStartup, MFMediaType_Video, MFT_REGISTER_TYPE_INFO, MFT_CATEGORY_VIDEO_DECODER,
    ...
    MFVideoInterlace_Progressive, MFSTARTUP_FULL, MF_E_TRANSFORM_NEED_MORE_INPUT,
