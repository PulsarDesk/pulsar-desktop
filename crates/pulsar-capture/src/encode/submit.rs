...
use windows::Win32::Graphics::Direct3D11::{
    ...
    D3D11_TEX2D_VPOV, D3D11_VIDEO_PROCESSOR_INPUT_VIEW_DESC,
...
impl Encoder {
    ...
    pub unsafe fn submit(&mut self, frame: &Frame, pts: i64) -> Result<(), String> {
        ...
        let map_fn = self.fns.nvEncMapInputResource.ok_or("nvEncMapInputResource missing")?;
    ...
    unsafe fn blt_bgra_to_nv12(&mut self, src: &ID3D11Texture2D) -> Result<(), String> {
        ...
        let blt = self
            .vctx
            .VideoProcessorBlt(&self.vproc, &output_view, 0, std::slice::from_ref(&stream));
