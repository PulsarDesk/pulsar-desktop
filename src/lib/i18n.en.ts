...
export const en: Dict = {
	...
	'chrome.split': 'Split screen',
	'chrome.splitToggle': 'Split the screen / leave split mode',

	// Split mode (grid of independent sessions)
	'split.title': 'How should the screen split?',
	'split.sub': 'Each pane runs an independent session — to the same or different hosts.',
	'split.subRemote': 'Each pane is an independent remote-desktop session — to the same or different hosts.',
	'split.subGame': 'Each pane is an independent game-stream session — to the same or different hosts.',
	'split.h2': '2 side by side',
	'split.v2': '2 stacked',
	'split.grid4': '2×2 (four)',
	'split.exit': 'Leave split mode',
	'split.close': 'Close',
	'split.paneConnect': 'Connect this pane',
	'split.pane': 'Pane',
	'input.assignTitle': 'Input device → pane',
	'input.assignDesc':
		'Lock each keyboard/mouse/controller to a pane — separate players use separate gear (couch co-op). An unlocked device follows the focused pane.',
	'input.controllers': 'Controllers',
	'input.keyboards': 'Keyboard / Mouse',
	'input.followFocus': 'Follow focus',
	'input.noControllers': 'No controllers connected.',
	'input.noKbm': 'No captured keyboard/mouse (Linux client only).',
	'chrome.inputAssign': 'Input device assignment',
	'split.pickGame': 'Pick a game',
	'split.captureMode': 'How to capture?',
	'split.modeDisplay': 'Display',
	'split.modeGame': 'Game',
	'split.modeWindow': 'Window',
	'split.modeDisplayHint': 'Share a whole monitor',
	'split.modeGameHint': 'Host launches the app and captures its window',
	'split.modeWindowHint': 'Pick an open window on the host',
	'split.pickWindow': 'Pick a window',
	'split.noWindows': 'No windows to capture',
	'split.windowNeedsSession': 'Window capture needs a session already connected to this host',
	'tab.home': 'Home',
	'tab.close': 'Close tab',
	...
	'toast.padConnected': 'controller connected',
	...
	'gaming.recents': 'Recent connections',
	'gaming.noRecents': 'No connections yet. They appear here once you connect to a device.',
	'recent.edit': 'Edit',
	'recent.editTitle': 'Edit recent',
	'recent.name': 'Name',
	'recent.namePlaceholder': 'Host name',
	'recent.image': 'Image',
	'recent.imageHint': 'Pick an icon or upload a picture',
	...
	'controllers.slot': 'Player',
	'controllers.reorderHint': 'Use the arrows to change the player slot order.',
	'controllers.rumble': 'Vibration',
	'controllers.enabled': 'On',
	'controllers.disabled': 'Off',
	'controllers.battery': 'Battery',
	'controllers.emulation': 'Emulation',
	'controllers.emuAuto': 'Auto',
	'controllers.emuXbox': 'Xbox 360',
	'controllers.emuDs4': 'DualShock 4',
	'controllers.rumbleOff': 'Off',
	'controllers.rumbleWeak': 'Weak',
	'controllers.rumbleMedium': 'Medium',
	'controllers.rumbleStrong': 'Strong',
	'controllers.test': 'Test vibration',
	'controllers.testBtn': 'Test',
	'controllers.lock': 'Lock to this session',
	'controllers.locked': 'Locked',
	'controllers.aMoveUp': 'Move up',
	'controllers.aMoveDown': 'Move down',
	'controllers.bothModes': 'Controllers are forwarded in both remote desktop and game streaming sessions.',
	...
	'settings.uiHwaccel': 'App UI hardware acceleration',
	'settings.uiHwaccelDesc':
		"Draws the app's OWN interface (menus, settings) with the GPU — SEPARATE from the video stream's encode/decode. Default OFF on the Orange Pi 5 (a driver bug can freeze it); on elsewhere. A change applies after an app restart.",
	...
	'games.fCoverPlaceholder': 'https://… or paste a path',
	'games.fCoverUpload': 'Upload',
	'games.fCoverClear': 'Remove cover',
